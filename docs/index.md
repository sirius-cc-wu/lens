...
- [ADR-009: Select a PlantUML renderer per viewing session](decisions/adr-009-selectable-plantuml-rendering.md)
- [ADR-010: Package Linux binary release artifacts](decisions/adr-010-linux-binary-release-artifacts.md)
- [ADR-011: Keep diagram controls inside a viewing session](decisions/adr-011-diagram-failure-controls.md)

...
| `R-03` | File and directory resolution can expose files outside the requested repository. | Technical / security | Medium | High | E1 canonicalizes the selected file and serves only fixed viewer routes plus known diagram identifiers. Traversal and symlink behavior are tested. Directory authorization remains an E2 risk. |
